            ...
            <div className='searchDetails'>
                {
                    ...
                    products && products.map((pr)=>{
                        return < SearchProducts pr={pr} closeSearch= {closeSearch}/>
                    })
                }
            </div>
        </div>
        ...
        <div className="header-desktop">
            <div className="container">
                    ...
                    <div className='menu-icon'>
                        ...
                        <div className='hidden' ref={Hamburgur}>
                            ...
                            <div className='menu-option'>
                                ...
                                <li onClick={closed}><Link to="collections/tshirts">T-shirts</Link></li>
                                <li onClick={closed}><Link to="collections/watches">Watches</Link></li>
                ...
                <div className="right-menu">
                    ...
                    <Link to={loading === false && isAuthenticated?"/account":"/login"}><button className = "right-menu-btn"><PersonOutlineOutlinedIcon/></button></Link>
                    <div>

...
exports.forgetpassword = catchAsyncError(async(req,res,next)=>{
    ...
    const message = `You're receiving this e-mail because you or someone else has requested a password reset for your account at.
    ...
    try{
        ...
        res.status(200).json({
            success:true,
            message:`An email has been sent to ${user.email} successfully`
        })
